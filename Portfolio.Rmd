...
Data_01 <- Data_01 %>%
  mutate(
    log_sunday_weight = log(sunday_weight),  # Log transformation
    z_sunday_weight = (sunday_weight - mean(sunday_weight, na.rm = TRUE)) / sd(sunday_weight, na.rm = TRUE)  # Z-score standardization
  )
```
